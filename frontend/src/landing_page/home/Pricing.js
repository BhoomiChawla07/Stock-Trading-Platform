        ...
        <div className='container p-5 mt-5'>
            <div className='row '>
                <div className='col-5 p-5'>
                    ...
                    <a href='#'style={{textDecoration:"none", fontSize:"1.25rem"}}>See pricing  <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                </div>
                
                <div className='col-7 mt-4 p-5' style={{display:"flex", gap:"1rem"}}>
                    <div>
                        <img src='media/pricing-eq.svg' style={{width:"65%"}}/>
                    ...
                    <div>
                        <img src='media/other-trades.svg' style={{width:"65%"}}/>
