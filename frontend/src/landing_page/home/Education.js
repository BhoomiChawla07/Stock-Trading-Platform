       ...
       <div className='container  '>
            <div className='row p-5'>
                ...
                <div className='col-6 p-5'>
                    ...
                    <a style={{textDecoration:"none", fontSize:"1.25rem"}}>Varsity  <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                    ...
                    <a style={{textDecoration:"none", fontSize:"1.25rem"}}>TradingQ&A  <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                </div>
            </div>
       </div>
     );
