        ...
        <div className='container mt-5' style={{marginTop:"5rem"}}>
            <div className='row text-center'>
                ...
                <div className='col-4 p-3' style={{marginTop:"3rem"}}>
                    <img src='media/smallcaseLogo.png' alt='smallcase'></img>
                ...
                <div className='col-4 p-3' style={{marginTop:"3rem"}}>
                    <img src='media/zerodhaFundhouse.png' alt='zerodha fundhouse' style={{width:"50%"}}></img>
                ...
                <div className='col-4 p-3' style={{marginTop:"3rem"}}>
                    <img src='media/sensibullLogo.svg' alt='Sensibull Logo' style={{width:"50%"}}></img>
                ...
                <div className='col-4 p-3' style={{marginTop:"3rem"}}>
                    <img src='media/streakLogo.png' alt='Streak Logo' style={{width:"50%"}}></img>
                ...
                <div className='col-4 p-3' style={{marginTop:"3rem"}}>
                    <img src='media/dittoLogo.png' alt='Ditto Logo' style={{width:"40%"}} ></img>
                ...
                <div className='col-4 p-3' style={{marginTop:"3rem"}}>
                    <img src='media/goldenpiLogo.png' alt='GoldenPi Logo' style={{width:"50%"}}></img>
